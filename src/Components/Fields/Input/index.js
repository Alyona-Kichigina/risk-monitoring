...
class Input extends Component {
  ...
  render() {
    const {
      ...
      onKeyUp, onBlur, onFocus, minHeight, ShowInputFillIndicator, name
    } = this.props
    ...
    return (
      <div
        className={`display-flex input-box ${className}`}
      ...
      >
        ...
        >
          <Input
            ...
            value={value}
            maxLength={maxlength}
            className={`input-control caret-color-blackDarken-1 ${disabled ? "disabled" : ""}`}
